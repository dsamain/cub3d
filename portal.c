...
/*   Updated: 2022/07/01 22:39:59 by dsamain          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_pos	get_new_ray_pos2(t_data *data, t_ray *ray,
...
t_pos	get_new_ray_pos(t_data *data, t_ray *ray,
	t_portal *portal, t_portal *other_portal)
{
	t_pos	pos;
	double	wall_x;
	...
	else if (portal->ori == 1)
	{
		...
		pos = get_new_ray_pos2(data, ray, portal, other_portal);
	return (pos);
}
